...
# Висновок
   Проект messenger допоміг нам зрозуміти як створювати сильний проект на фреймворці django який більш швидкий за flask, також ми зрозуміли як працювати з асинхронністью у web-додатках, також ми працювали з більш складною структурою бази даних. Це був дуже цікавий та складний проект для нас.
   ...
   Взагалом цей проект був для нас крутим досвідом, та додатком до нашого профілю гіт-хаб!
