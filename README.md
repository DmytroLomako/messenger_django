...
# Висновок
   Проект messenger допоміг нам зрозуміти як створювати сильний проект на фреймворці django який більш швидкий за flask, також ми зрозуміли як працювати з асинхронностью у веб додатках, також ми поработали з більш складною структурою бази даних. Це був дуже цікавий та складний проект,
   ми вперше попрацювали з websocket та  ajax. 
   
   Складніше за все для нас було настроїти websocket та channels щоб чати працювали вірно, та дуже складно для нас було зробити додаток друзів, дуже багато зв'язків, та коду на бекенді. Багато роботи із фронт-ендом, з javascript, html та css

   Взагалом цей преокт був для нас крутим досвідом, та додатком до нашого профілю гіт-хаб!
